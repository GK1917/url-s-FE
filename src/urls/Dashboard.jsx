...
import { fetchUrls } from "../slice/urlApi";
import { useForm } from "react-hook-form";
import { createUrl } from "../slice/urlApi";
            ...
            <div className="mx-auto p-4 max-w-[1200px]">
                ...
                <div className="bg-white shadow rounded p-4 mt-4">
                    <div className="mb-4">
                        ...
                        {errors.fullUrl && (<span className="error w-full max-w-[380px] ml-5 text-red-500 font-normal">
